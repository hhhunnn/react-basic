...
// - 쿠키 설정, 검색, 삭제를 간단히 함수로 작업할 수 있도록 함

// npm i react-cookie
export default function ReactCookieLibrary() {

    // useCookies 훅 함수로 쿠키 객체, 쿠기 지정 함수, 쿠키 삭제 함수를 배열로 반환 받음
    ...
    const onRegistButtonClickHandler = () => {
        ...
        // setCookie 함수는 첫번재 매개변수로 name 값/ 두번째 매개변수를 Vues 값, 세번째 매개변수로 option 지정
